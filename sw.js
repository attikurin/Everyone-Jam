...
const PRECACHE_URLS = [
  ...
  './js/state.js?v=1.10.1',
  './js/tools.js?v=1.10.1',
  './js/board.js?v=1.10.1',
  './js/pages.js?v=1.10.1',
  './js/sync.js?v=1.10.1',
  './js/p2p.js?v=1.10.1',
  './js/export.js?v=1.10.1',
  './js/qr.js?v=1.10.1',
  './js/timer.js?v=1.10.1',
  './js/lock.js?v=1.10.1',
  './js/collab.js?v=1.10.1',
  './js/giga.js?v=1.10.1',
  './js/organize.js?v=1.10.1',
  './js/dashboard.js?v=1.10.1',
  './js/templates.js?v=1.10.1',
  './js/import.js?v=1.10.1',
  './js/ocr.js?v=1.10.1',
  './js/poll.js?v=1.10.1',
  './js/app.js?v=1.10.1',
  './icons/icon-192.png',
